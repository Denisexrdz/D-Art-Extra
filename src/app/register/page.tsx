...
import Bocanada from '@/Css/imagenes/Bocanada.jpeg'
import Moshe from '@/Css/imagenes/Moshe.jpg'
import Abogato from '@/Css/imagenes/Abogato.jpeg'
export default function Register() {
  ...
  const validation = () => {
    ...
    if (/<.*?>.*?<\/.*?>/i.test(email) || /<.*?>.*?<\/.*?>/i.test(password) || /<.*?>.*?<\/.*?>/i.test(username)){
          ...
          console.log('Acount created')
            ...
            .then(() => {
              ...
              setDoc(userDoc, {
                  usu_nombre: username,
                  usu_email: email,
                  usu_fotoperfil: 'url_de_imagen_predeterminada', 
                  usu_fotoportada: 'url_de_imagen_predeterminada', 
                  usu_descripcion: 'Esta es una descripción predeterminada' 
              })
              .then(() => {
  ...
  return (
    <div >
      ...
      <div className='container'>
        <div className='Title'>
          <h1 className='TitleModak'>
            Deja de buscar y encuentra con
          </h1>
          <Link href={'../'}>
        ...
        <div className='CreaTC'>
          <h2>Ya tienes una cuenta? <Link href={"../login"}>Inicia Sesion</Link></h2>
        ...
        <div className='Campos'>
          <div className='Form'>
            ...
            <div className='BtnRegistro' onClick={handleSignUp}>
              <button 
              
              className= "Registrarse">Registrarse</button>
            </div>
      ...
      <div className='imagenes'>
        <div className='imgg1'>
          <Image src={Bocanada} alt='BocanadaPA' className='img1'></Image>
        </div>
        
        <div className='imgg2'>
          <Image src={Moshe} alt='Moshe' className='img2'></Image>
        </div>
        <div className='imgg3'>
          <Image src={Abogato} alt='Moshe' className='img3'></Image>
        </div>
        <div className='TextoImg'>
        <b>Hacer comisiones</b> <p>Nunca fue tan fácil</p>
        </div>
      </div>
      </div>
